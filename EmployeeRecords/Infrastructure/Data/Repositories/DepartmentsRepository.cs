...
public class DepartmentsRepository : Repository<Department>, IDepartmentsRepository
{
	...
	public async Task<Department?> GetByIdAsync(int id)
	{
		...
		var departments = await ExecuteReaderAsync(sqlStatement, new[] { idParameter });
	...
	public async Task<Department?> GetByNameAsync(string name)
	{
		...
		var departments = await ExecuteReaderAsync(sqlStatement, new[] { nameParameter });
		return departments.SingleOrDefault();
	}
	...
	public async Task<IEnumerable<Department>> GetAsync(Query? query = null)
	{
		...
		var departments = await ExecuteReaderAsync(sqlStatement, parameters.ToArray());
		return departments;
	}
